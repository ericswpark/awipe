...
class FAQActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        faqList.add(
            FAQ(
                getString(R.string.faq_activity_overshoot_title),
                getString(R.string.faq_activity_overshoot_description)
            )
        )
        faqList.add(
            FAQ(
                getString(R.string.faq_activity_undershoot_title),
                getString(R.string.faq_activity_undershoot_description)
            )
        )
        faqList.add(
            FAQ(
                getString(R.string.faq_activity_leftover_space_title),
                getString(R.string.faq_activity_leftover_space_description)
            )
        )
        faqList.add(
            FAQ(
                getString(R.string.faq_activity_force_close_title),
                getString(R.string.faq_activity_force_close_description)
            )
        )
        faqList.add(
            FAQ(
                getString(R.string.faq_activity_wipe_security_title),
